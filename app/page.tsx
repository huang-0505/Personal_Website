...
const suggestedQuestions = [
  ...
  "Tell me about the Harvard MLOps project",
  "What are your technical skills?",
  "Tell me about VetLLM at Onawa Pet",
...
const personalInfo = {
  ...
  experience: "1+ years building ML & GenAI solutions",
  email: "junhui_huang@brown.edu",
  bio: "AI Engineer and Data Scientist with experience in data pipelines, fine-tuning Transformer models (LoRA), and deploying large-scale models (vLLM, TensorRT). M.S. Data Science at Brown University.",
  skills: [
    "Python",
    "PyTorch",
    "HuggingFace",
          ...
          <div className="flex justify-center gap-4 mb-8">
            ...
            <Link href="/resume">
              <Button
                variant="outline"
                size="sm"
                className="bg-white/80 dark:bg-slate-800/80 hover:bg-white dark:hover:bg-slate-700 backdrop-blur-sm border-2 hover:border-green-300 dark:hover:border-green-500 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 group"
              >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-700/50 dark:to-slate-600/50 p-6 rounded-2xl shadow-lg">
                  ...
                  <div className="space-y-3 text-slate-600 dark:text-slate-300">
                    ...
                    <div className="flex items-center gap-3">{personalInfo.location}</div>
                  </div>
                </div>
